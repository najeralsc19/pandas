...
# Cargar el archivo GeoJSON con los límites de los municipios
gdf = gpd.read_file("E://files_pandas//sisver//municipios_hidalgo.geojson")

# Filtrar el municipio específico (por ejemplo, "Pachuca de Soto")
...
# Añadir el contorno del municipio al mapa
